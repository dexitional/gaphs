...
service: 'gmail',
auth: {
        user: 'unifabro@gmail.com',
        pass: 'unifa2020__'
    }
});

module.exports = function(email,name,title,msg) {
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: #f3f3f3; min-width: 350px; font-size: 1px; line-height: normal;">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;margin-bottom:20px;">
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <div style="height:25px;line-height:25pxpx;font-size:24px;font-weight:bolder;color:#0d2d62;text-transform:uppercase;text-decoration:underline;text-align:center;">${title}</div>
                     ...
                     <tr>
                        <td align="left" valign="top">
                           <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 22px; line-height: 22px; font-weight: 300; letter-spacing: -1.5px;">
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 22px; line-height: 22px; font-weight: 300; letter-spacing: -1.5px;">Hi ${name},</span>
                           </font>
                           ...
                           <div style="height: 20px; line-height: 20px; font-size: 18px;">&nbsp;</div>
                          <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: steelblue; border-radius: 4px;">
                              <tr>
                                 <td align="center" valign="top"> 
                                    <a href="https://hrms.ucc.edu.gh" target="_blank" style="display: block; border: 1px solid steelblue; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                       <font face="'Source Sans Pro', sans-serif" color="#ffffff" style="font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Explore&nbsp;HRMS</span>
                                       </font>
                                    </a>
                                 </td>
                              </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td class="mob_center" align="left" valign="top">
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 11px; line-height: 13px; font-weight: 400;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 11px; line-height: 13px; font-weight: 600;">DIRECTORATE OF HUMAN RESOURCE MANAGEMENT</span>
                                       </font>
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#7f7f7f" style="font-size: 18px; line-height: 15px;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 18px; line-height: 15px;">UNIVERSITY OF CAPE COAST</span>
                                       </font>
                                    </td>
                                    <td width="18" style="width: 18px; max-width: 18px; min-width: 18px;">&nbsp;</td>
                                 </tr>
                           ...
                           <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                              <tr>
                                 <td align="center" valign="top">
                                    ...
                                    <div style="height: 15px; line-height: 15px; font-size: 13px;">&nbsp;</div>
                                    <font face="'Source Sans Pro', sans-serif" color="#868686" style="font-size: 11px; line-height: 15px;">
                                       <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #868686; font-size: 11px; line-height: 15px;"><small>Copyright &copy; ${new Date().getFullYear()} HRMS. All&nbsp;Rights&nbsp;Reserved.</small></span>
                                    </font>
                                    <div style="height: 3px; line-height: 3px; font-size: 1px;">&nbsp;</div>
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 11px; line-height: 15px;">
                                       <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 11px; line-height: 15px;">
                                        <small>
                                            <a href="#" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 11px; line-height: 13px; text-decoration: none;">+233-3321-32480/3 Exts.: 223/225/205<br>233-3321-32484/5</a> &nbsp;&nbsp;|&nbsp;&nbsp; 
                                            <a href="mailto:dhr@ucc.edu.gh" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 11px; line-height: 13px; text-decoration: none;">dhr@ucc.edu.gh</a> &nbsp;&nbsp;|&nbsp;&nbsp; 
                                            <a href="#" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 11px; line-height: 13px; text-decoration: none;">Powered By <em>MIS-DICTS.</em></a>
                                         </small>
                                       </span>
                                    </font>
    ...
    let data = {
        sender: 'unifabro@gmail.com',
        to: (email != null ? email : 'unifabro@gmail.com'),
        subject: title,
        text: msg,
        html: html
    };
